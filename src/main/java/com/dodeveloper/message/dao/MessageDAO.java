...
public interface MessageDAO {
    ...
    List<MessageVO> selectReceivedMessages(String receiver, String writer, String title, String content, int startPoint,
    ...
    List<MessageVO> selectMessagesByReceiverAndWriter(String receiver, String writer, int startPoint, int amountToShow)
	    throws Exception;

    List<MessageVO> selectMessagesByReceiverAndTitle(String receiver, String title, int startPoint, int amountToShow)
	    throws Exception;

    List<MessageVO> selectMessagesByReceiverAndContent(String receiver, String content, int startPoint,
	    int amountToShow) throws Exception;

    List<MessageVO> selectSentMessages(String writer, String title, String content, int startPoint, int amountToShow)
	    throws Exception;

    List<MessageVO> selectMessagesByWriter(String writer, int startPoint, int amountToShow) throws Exception;

    List<MessageVO> selectMessagesByWriterAndTitle(String writer, String title, int startPoint, int amountToShow)
	    throws Exception;

    List<MessageVO> selectMessagesByWriterAndContent(String writer, String content, int startPoint, int amountToShow)
	    throws Exception;
