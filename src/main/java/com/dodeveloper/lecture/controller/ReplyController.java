...
public class ReplyController {
     ...
     * @return : ResponseEntity<List<ReplyVO>> ResponseEntity - 응답하려는 데이터(json) + 응답
     *         코드(HttpStatus)를 함께 가지고 응답 할 수 있는 객체
    ...
    public ResponseEntity<String> insertReply(@PathVariable("bNo") int bNo, @PathVariable("bType") int bType,
