		...
		<section id="register" class="basic">
			<div class="container" data-aos="fade-up" data-aos-delay="200">
				...
				<div class="d-flex justify-content-center">
					<div class="form-register form-control p-4" style="max-width: 330px">
									...
									<div class="d-flex flex-column">
										<div class="mb-3 mt-2">
											<div class="label-group">
												<label for="userId" class="form-label">아이디</label><span id="errorMsgUserId" class="errMessage"></span>
											</div>
											<input type="text" class="form-control" id="userId" name="userId" /> <input type="hidden" id="checkUserId" value="false" />
										</div>
										<div class="mb-3 mt-2">
											<div class="label-group">
												<label for="userPwd" class="form-label">비밀번호</label><span id="errorMsgUserPwd" class="errMessage"></span>
											</div>
											<input type="password" class="form-control" id="userPwd" name="userPwd" />
										</div>
										<div class="mb-3 mt-2">
											<div class="label-group">
												<label for="userPwdConfirm" class="form-label">비밀번호 확인</label><span id="errorMsgUserPwdConfirm" class="errMessage"></span>
											</div>
											<input type="password" class="form-control" id="userPwdConfirm" />
										</div>
										<div class="mb-3 mt-2">
											<label for="userName" class="form-label">이름</label><input type="text" class="form-control" id="userName" name="userName" required="required" />
										</div>
										<div class="mb-3 mt-2">
											<div class="label-group">
												<label for="email" class="form-label">이메일</label><span id="errorMsgEmail" class="errMessage"></span>
											</div>
											<input type="text" class="form-control" id="email" name="email" />
										</div>
										<div class="d-grid">
											<button type="submit" class="btn btn-block btn-register mt-2" onclick="return validate()">가입하기</button>
										</div>
									</div>
								</form>
							</div>
