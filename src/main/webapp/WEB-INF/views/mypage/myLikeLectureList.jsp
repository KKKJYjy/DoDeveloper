		...
		<section id="lecture" class="lectureBasic">
			...
			<div class="container" style="width: 70%">
				...
				<div class="container">
					...
					<c:forEach var="lectureLike" items="${lectureLikeList}">
					...
					<ul class="pagination">
						<c:if test="${param.pageNo > 1}">
							<li class="page-item "><a class="page-link"
								href="/mypage/myLikeLectureList?pageNo=${param.pageNo -1 }">Previous</a></li>
						</c:if>
						<c:forEach var="i"
							begin="${pagingInfo.startNumOfCurrentPagingBlock }"
							end="${pagingInfo.endNumOfCurrentPagingBlock }" step="1">
							<li class="page-item " id="${i }"><a class="page-link"
								href="/mypage/myLikeLectureList?pageNo=${i }">${i }</a></li>
						</c:forEach>
						<c:if test="${param.pageNo < pagingInfo.totalPageCnt}">
							<li class="page-item "><a class="page-link"
								href="/mypage/myLikeLectureList?pageNo=${param.pageNo +1 }">Next</a></li>
						</c:if>
					</ul>
