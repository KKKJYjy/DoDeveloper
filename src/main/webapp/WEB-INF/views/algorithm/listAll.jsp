...
<script>
	...
	function insertTable(data) {
		...
		for (let i = 1; i < arr.length; i++) {
			...
			console.log(title);
			document.getElementsByClassName("myLink")[i - 1].href = "/algorithm/algDetail?boardNo="
					+ no;
								...
								<ul class="big_menu">
									...
									<c:forEach var="algClass" items="${algClassification}">
										<ul class="small_menu">
											...
											<li onclick="classCodeFilter(this.value)"
												value="${algClass.code}">${algClass.algClassification}</li>
