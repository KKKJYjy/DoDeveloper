...
import="java.io.Console"%> <%@page
import="com.dodeveloper.algorithm.vodto.AlgDetailDTO"%> <%@ page language="java"
...
<html lang="ko">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <%@ include file="../header.jsp"%> <% String boardNo =
    request.getParameter("boardNo"); session.setAttribute("boardNo", boardNo);
    %>
    ...
    <main id="main">
      ...
      <form method="get" action="/algorithm/writeDetailPOST">
        <div class="btns">
          ...
          <button
            type="button"
            class="btn btn-info"
            onclick="location.href='/algorithm/modifyAlgDetail';"
          >
            글수정
          </button>
        </div>
      ...
      <button
        ...
        onclick="location.href='/algorithm/listAll';"
      >
        알고리즘목록
      </button>
