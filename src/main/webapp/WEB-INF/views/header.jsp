	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		<div
			...
			<a href="/" class="logo d-flex align-items-center me-auto me-xl-0">
				...
				<!-- <img src="/resources/assets/img/logo.png" alt=""> --> 띠브 <span>DDev</span>
			</a>
					...
					<li>
						<a href="/message">쪽지함
							<c:if test="${sessionScope.unreadMessageCount > 0 }">
								<span style="background-color: red; border-radius: 30%; color: white;">${sessionScope.unreadMessageCount}</span>
							</c:if>
						</a>
					</li>
			...
			<div class="d-flex align-items-center">
				<c:choose>
					<c:when test="${sessionScope.loginMember != null}">
						<li class="loginUser me-3"><a href="/mypage/myProfile"> <span>${sessionScope.loginMember.userName}
									님!<span></a></li>
